...
#define I2C_SDA1 21    // MPU-9250
#define I2C_SCL1 22    // MPU-9250
...
uint8_t mpu6050[12];                  // Byte array to send over bluetooth classic
float mpu6050_print[6];               // To print the converted values
...
void loop() {
    if(deviceConnected){
      ...
      // ============== Read MPU-9250 data ===============//
      mpu6050[6] = mpu6050_readSensor(MPU6050_ACCEL_XOUT_H,I2C_SDA1,I2C_SCL1);
      mpu6050[7] = mpu6050_readSensor(MPU6050_ACCEL_XOUT_L,I2C_SDA1,I2C_SCL1);
      mpu6050[8] = mpu6050_readSensor(MPU6050_ACCEL_YOUT_H,I2C_SDA1,I2C_SCL1);
      mpu6050[9] = mpu6050_readSensor(MPU6050_ACCEL_YOUT_L,I2C_SDA1,I2C_SCL1);
      mpu6050[10] = mpu6050_readSensor(MPU6050_ACCEL_ZOUT_H,I2C_SDA1,I2C_SCL1);
      mpu6050[11] = mpu6050_readSensor(MPU6050_ACCEL_ZOUT_L,I2C_SDA1,I2C_SCL1);
      ...
      // MPU-9250
      mpu6050_print[3] = ((mpu6050[6]<<8)+mpu6050[7])/2048.0;
      mpu6050_print[4] = ((mpu6050[8]<<8)+mpu6050[9])/2048.0;
      mpu6050_print[5] = ((mpu6050[10]<<8)+mpu6050[11])/2048.0;
      ...
      if (currentMillis - previousMillis >= interval){
        ...
        Serial.println("");
        Serial.print("MPU-9250: ");
        Serial.print(mpu6050[6]);
        Serial.print(" ");
        Serial.print(mpu6050[7]);
        Serial.print(",");
        Serial.print(mpu6050[8]);
        Serial.print(" ");
        Serial.print(mpu6050[9]);
        Serial.print(",");
        Serial.print(mpu6050[10]);
        Serial.print(" ");
        Serial.print(mpu6050[11]);  
        Serial.println("");
        ...
        Serial.println("");
        Serial.print("MPU-9250: ");
        Serial.print(mpu6050_print[3]);
        Serial.print(",");
        Serial.print(mpu6050_print[4]);
        Serial.print(",");
        Serial.print(mpu6050_print[5]);
        Serial.println("");
      } 
    }
